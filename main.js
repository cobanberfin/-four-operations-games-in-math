...
var Counter = {
    ...
    {
        this.operation=this.operations[this.GenerateOperations()];
        ...
        switch (this.operation) {
            ...
            case "*":
                ...
                break;
            case "/":
            this.CorrectAnswer =( this.FirstNumber / this.SecondNumber).toFixed(1);
            break;
        ...
        this.AddContentToElement("section#question", this.FirstNumber + this.operation + this.SecondNumber);
    ...
    EventListener: function(event)
    {
        ...
        else
        {
            ...
            Counter.AddContentToElement("p#message", "TRY AGAİN :(");
        }
